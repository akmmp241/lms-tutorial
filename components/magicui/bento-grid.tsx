...
const BentoCard = ({
  ...
  <div
    key={name}
    className={cn(
      "group relative col-span-3 flex flex-col justify-between overflow-hidden rounded-xl hover:shadow-2xl hover:scale-90",
      // light styles
  ...
  >
    <Meteors number={30} className={"hidden group-hover:inline"} />
    <div>{background}</div>
